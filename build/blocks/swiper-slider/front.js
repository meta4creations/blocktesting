...
/***/ "./src/blocks/swiper-slider/front.scss":
/*!*********************************************!*\
  !*** ./src/blocks/swiper-slider/front.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*******************************************!*\
  !*** ./src/blocks/swiper-slider/front.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _front_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./front.scss */ "./src/blocks/swiper-slider/front.scss");
...
jQuery(function ($) {
  ...
  (function () {
    ...
    function initSwiper($el) {
      const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]($el.find('.swiper')[0], {
        slidesPerView: 1,
        loop: true,
        spaceBetween: 0,
    ...
    $(`.${block}`).each(function () {
      const $innerBlocks = $(this).find('.swiper-wrapper').children();
